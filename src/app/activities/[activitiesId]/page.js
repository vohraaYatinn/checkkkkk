  ...
  const [
    ...
    console.log(id);
      ...
      const fetchActivityByIdfunction = () => {
        activityFetch(getSingleActivityById({},id ));
      };
      useEffect(()=>{
      ...
      <div className="package-details-area pt-120 mb-120 act-dtl-ui">
        <div className="container">
          ...
          <tr key={index}>
            ...
            {/* Extra Service Dropdown */}
            <td>
              <SelectComponent
                options={variation.extraService.map(
                  (service) => service.extraServiceName
                )}
                placeholder={[variation.extraService[0]?.extraServiceName]}
              />
            </td>
            ...
            {/* Price */}
            <td className="act-dtl-price">
              AED {variation.extraService[0]?.pricing?.adult || "0"}.00
            </td>
          </tr>
        ))}
