...
const Page = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      sendEmail(formData?.fullName, formData?.email, formData?.countryCode + formData?.phone, "Abu Dhabi Tour With Heritage Village & Grand Mosque", formData?.message)
  ...
  return (
      ...
      <div className="container"> 
        ...
        <div className="row g-xl-4 gy-5 main-package-details-div">
          <div className="col-xl-8">
            ...
            <h2>Abu Dhabi Tour With Heritage Village & Grand Mosque
            </h2>
            ...
            <p className="para-activity">Explore the rich cultural heritage and modern marvels of Abu Dhabi on this comprehensive 8-hour tour. Visit iconic landmarks such as the Sheikh Zayed Grand Mosque and the Heritage Village and enjoy scenic photo stops at the Abu Dhabi Corniche and Emirates Palace. This tour offers a perfect blend of history, culture, and breathtaking architecture, providing an unforgettable experience in the UAE's capital city.
            ...
            <div className="highlight-tour mb-20">
              ...
              <ul>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Visit the magnificent Sheikh Zayed Grand Mosque
                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Explore the Heritage Village

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Scenic photo stop at Abu Dhabi Corniche

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Photo opportunity at the luxurious Emirates Palace

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Visit Marina Mall for some leisure time

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Discover the Dates Market

                </li>
                <li><span className="activity-back-icon"><i className="bi bi-check" /></span> Photo stop at Ferrari World
    ...
    <li><b className="bold-activity">Wheelchair Accessibility:</b> This tour is wheelchair accessible. However, it is required that another person accompanying the one in the wheelchair must assist and push the wheelchair throughout the tour. Guests must supply their own wheelchair. We strive to make our tours as inclusive as possible and are here to accommodate your needs to the best of our ability in the UAE.
            ...
            <div className="includ-and-exclud-area mb-20">
              <ul>
                ...
                <li><i className="bi bi-check-lg" /> Sheikh Zayed Grand Mosque For All Participants
                </li>
                <li><i className="bi bi-check-lg" /> Heritage Village for All Participants
        ...
        <ul>
          <li>Conclude your tour with a comfortable drop-off at your hotel or accommodation, bringing an end to a day filled with memorable sights and experiences.</li>
           ...
           <div className="review-section">
            ...
            <h3>Be the first to review “Abu Dhabi Tour With Heritage Village & Grand Mosque
            ”</h3>
